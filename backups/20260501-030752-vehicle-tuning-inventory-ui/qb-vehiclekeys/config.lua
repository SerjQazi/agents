...
-- AGENT FIX START: configurable NPC/world vehicle lock behavior
Config.LockNPCDrivingCars = false -- Legacy alias; kept for compatibility with older config references
Config.DrivingNpcVehicleLocked = false -- Lock state for NPC cars being driven by NPCs [true = locked, false = unlocked]
Config.LockNPCParkedCars = true -- Legacy alias; kept for compatibility with older config references
Config.ParkedVehicleLockChance = 80 -- Percentage chance for parked NPC/world vehicles to be locked
Config.AdvancedLockpickClasses = { -- Vehicle classes that require an advanced lockpick
    [6] = true, -- Sports
    [7] = true, -- Super
}
-- AGENT FIX END
