...
Planner Agent is an isolated, local-only, plan-only MVP for FiveM script analysis
...
- Reports: `/home/agentzero/agents/reports/planner-agent/`
- Logs: `/home/agentzero/agents/logs/planner-agent/`
- Memory: `/home/agentzero/agents/memory/planner-agent-memory.sqlite`
