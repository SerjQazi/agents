      ...
      <body>
        <main class="shell">
          <header class="hero glass">
            <div>
              <h1>AgentOS</h1>
              <p class="subtitle">Local AI control system</p>
          ...
          <section class="agents-panel glass" aria-label="Available agents">
            ...
            <ul class="agent-list" id="agents-list">
              <li><span class="icon"><svg viewBox="0 0 24 24"><path d="M12 3l7 4v6c0 4-3 7-7 8-4-1-7-4-7-8V7l7-4z"></path></svg></span><span><span class="agent-name">Loading</span><span class="agent-description">Fetching local agent registry</span></span></li>
            </ul>
          </section>
        ...
        <script>
          ...
          function agentCardHtml(name, description) {
            return `<li><span class="icon">${agentIcon(name)}</span><span><span class="agent-name">${escapeHtml(name)}</span><span class="agent-description">${escapeHtml(description)}</span></span></li>`;
          }
